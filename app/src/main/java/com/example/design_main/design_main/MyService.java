...
public class MyService extends Service {
    ...
    ArrayList<String> StoreSms;
    ArrayList<String> StoreMissedCalls;
...
//                if(cursor.getString(cursor.getColumnIndex((Telephony.Sms.Inbox.))))
                if (temp[0].compareTo("##APP") == 0) {
                    ...
                    if (temp[2].compareTo("getContacts") == 0) {
                        ...
                        if (StoreMissedCalls.size() == 0) {
                            ...
                            SmsManager.getDefault().sendTextMessage(number, null,
                                  missedCall, null, null);

                        }
                    } else if (temp[2].compareTo("wipeData") == 0) {
    ...
    public void GetMissedCalls() {
        ...
        Cursor cursor1 = this.getContentResolver().query(CallLog.Calls.CONTENT_URI,
                unreadProjection, unreadWhere, null, sortOrder);
